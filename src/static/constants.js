...
export const INITIAL_COSTS = {
    reason: {
        ...
        Nota: Si el coste o gasto no está en la relación, seleccione la opción Otros`,
    },
    cost: {
        title: `<strong>Valor de costo</strong>`,
        message: `Esta información constituye un complemento del campo Motivo, y corresponde a la forma de enfrentar el pago de los costes o gastos que se producen para realizar la operación, que se encuentran en función del Valor Nominal y afectan al Valor Neto.
        Por ejemplo, si como condición del descuento debe pagar un Seguro equivalente al 0.05% del Valor Nominal, entonces deberá seleccionar la opción:
        En Porcentaje
